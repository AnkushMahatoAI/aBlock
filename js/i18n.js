...
// MV3: document is not available in the service worker; treat it as the
// background process so all DOM-manipulation code below is safely skipped.
const isBackgroundProcess = typeof document === 'undefined' ||
