...
// MV3: dynamic import() is disallowed in ServiceWorkerGlobalScope (HTML spec).
// Use a static import instead so the module is resolved at load time.
...
class RedirectEngine {
    ...
    loadBuiltinResources(fetcher) {
        ...
        const fetches = [
            // MV3: replaced dynamic import() (disallowed in SW) with static import at top of file.
